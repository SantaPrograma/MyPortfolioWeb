...
const TimeLine = () =>{
    return(
        <div className="flex flex-col justify-center divide-y divide-salte-200">
            <div className="w-full max-w-3xl md:pb-40 md:pt-20">
                <div className="-my-6">
                    {dataAboutPage.slice().reverse().map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            after:translate-y-1.5">
                                ...
                                justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-white-600">
                                    {data.date}
                                </time>
                            ...
                            <p className="whitespace-pre-wrap text-slate-400">{data.description}</p>
